<template>
  <main>
    <section class="hero-section">
      <div class="hero-line">
        <div class="hero-image h-top"></div>
        <h1 class="bold">Creative Agency</h1>
      </div>
      <div class="hero-line">
        <h1>for the</h1>
        <div class="hero-image h-mid"></div>
      </div>
      <div class="hero-line">
        <div class="hero-image h-bottom"></div>
    ...
    <section class="skills-section">
      ...
      <div class="images">
        <img loading="lazy" src="../../public/foto_1.webp" alt="Foto og Video">
        <img loading="lazy" src="../../public/marketing_1.webp" alt="Marketing">
        <img loading="lazy" src="../../public/programming_1.webp" alt="Programmering">
        <img loading="lazy" src="../../public/webshop-vertical_1.webp" alt="Webshop">
      </div>
...
main
  ...
  .hero-section
    ...
    .hero-line
      ...
      .h-top
        background-image: url("../../public/hero-small.webp")
        height: clamp(120px, 10vh, 240px)
        width: 20%
        border-radius: 100px

      .h-mid
        background-image: url("../../public/hero-top.webp")
        height: clamp(120px, 10vh, 240px)
        width: 70%
        border-radius: 100px 0 100px 100px

      .h-bottom
        background-image: url("../../public/hero-bottom.webp")
        height: clamp(120px, 10vh, 240px)
        width: 70%
